...
namespace Keras.Applications
{
    ...
    public class NASNet : Base
    {
        private static dynamic caller = Instance.keras.applications.nasnet;
        ...
        /// </returns>
        public static Model NASNetLarge(Shape input_shape = null, bool include_top= true, string weights= "imagenet",
                                    NDarray input_tensor= null, string pooling= "None", int classes= 1000)
        {
            ...
            return new Model(InvokeStaticMethod(caller, "NASNetLarge", parameters));
        }
        ...
        /// A Keras model instance.
        /// </returns>
        public static Model NASNetMobile(Shape input_shape = null, bool include_top = true, string weights = "imagenet",
                                    NDarray input_tensor = null, string pooling = "None", int classes = 1000)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters["input_shape"] = input_shape;
            ...
            return new Model(InvokeStaticMethod(caller, "NASNetMobile", parameters));
        }
