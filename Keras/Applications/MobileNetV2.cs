...
namespace Keras.Applications
{
    ...
    public class MobileNetV2 : Base
    {
        private static dynamic caller = Instance.keras.applications.mobilenet_v2;
        ...
        /// </returns>
        public static Model GetModel(Shape input_shape = null, float alpha = 1, int depth_multiplier=1, bool include_top = true, string weights = "imagenet", 
                                    NDarray input_tensor = null, string pooling = "None", int classes = 1000)
        {
            ...
            return new Model(InvokeStaticMethod(caller, "MobileNetV2", parameters));
        }
