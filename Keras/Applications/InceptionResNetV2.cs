...
namespace Keras.Applications
{
    ...
    public class InceptionResNetV2 : Base
    {
        private static dynamic caller = Instance.keras.applications.inception_resnet_v2;
                                    ...
                                    Shape input_shape = null, string pooling = "None", int classes = 1000)
        {
            ...
            return new Model(InvokeStaticMethod(caller, "InceptionResNetV2", parameters));
        }
