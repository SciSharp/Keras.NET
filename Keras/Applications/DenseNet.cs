...
namespace Keras.Applications
{
    ...
    public class DenseNet : Base
    {
        private static dynamic caller = Instance.keras.applications.densenet;
        ...
        public static Model DenseNet121(int blocks, bool include_top= true, string weights= "imagenet", NDarray input_tensor= null, 
                                    Shape input_shape= null, string pooling= "None", int classes= 1000)
        {
            ...
            return new Model(InvokeStaticMethod(caller, "DenseNet121", parameters));
        }
        ...
        /// <param name="classes">optional number of classes to classify images into, only to be specified if include_top is True, and if no weights argument is specified.</param>
        /// <returns>A Keras model instance.</returns>
        public static Model DenseNet169(int blocks, bool include_top = true, string weights = "imagenet", NDarray input_tensor = null,
                                    Shape input_shape = null, string pooling = "None", int classes = 1000)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters["blocks"] = blocks;
        ...
        /// <param name="classes">optional number of classes to classify images into, only to be specified if include_top is True, and if no weights argument is specified.</param>
        /// <returns>A Keras model instance.</returns>
        public static Model DenseNet201(int blocks, bool include_top = true, string weights = "imagenet", NDarray input_tensor = null,
                                    Shape input_shape = null, string pooling = "None", int classes = 1000)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters["blocks"] = blocks;
